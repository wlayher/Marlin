...
#define STRING_CONFIG_H_AUTHOR "(Walter, Ender-3 Pro, SKR 1.4 Turbo, 2020-06-13)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 8, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -12, -1.15 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 22       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
